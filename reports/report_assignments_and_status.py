...
from db_read_operations import create_report_directory, get_parent_task, get_sub_tasks_and_assignments, write_report_header, convert_to_work_days, get_jira_link, get_assignments
...
def generate_assignments_report(conn, epos):
    ...
    report_filename = os.path.join('resources/reports/test', f"task-assignments-and-status-{epos.upper()}.md")
